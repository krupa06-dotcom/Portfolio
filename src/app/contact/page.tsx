    ...
    <div className="pt-32 pb-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
              ...
              {links.map((link) => {
                ...
                return (
                  <a
                    ...
                    className="group flex items-center gap-4 py-3 border-b border-border hover:border-accent/30 transition-colors"
                  >
                    <Icon className="w-5 h-5 text-muted group-hover:text-accent transition-colors shrink-0" />
                    <div>
                    ...
                    <ExternalLink className="w-4 h-4 text-muted/50 group-hover:text-accent transition-colors ml-auto shrink-0" />
                  </a>
                );
              })}
            </div>
          ...
          {/* Form */}
          <div>
            <p className="text-sm text-muted mb-6 font-mono tracking-[0.08em] uppercase">
              Send a message
            </p>
            <ContactForm />
          </div>
