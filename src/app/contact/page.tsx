      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-5 gap-16">
          <div className="lg:col-span-3 lg:pr-12">
            <h1 className="font-heading font-bold text-5xl lg:text-7xl tracking-[-0.03em] leading-[0.95] mb-6 text-primary">
              Say hello.
            </h1>
            ...
            <div className="space-y-6">
              {links.map((link) => {
                ...
                return (
                  ...
                  >
                    <Icon className="w-4 h-4 text-muted/60 group-hover:text-primary transition-colors shrink-0" />
                    <div>
                    ...
                    <ExternalLink className="w-3 h-3 text-muted/50 group-hover:text-primary transition-colors ml-auto shrink-0" />
                  </a>
                );
              })}
            </div>
