...
export default function ExperiencePreview({
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24" style={{ backgroundColor: "var(--dark-bg)" }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="mb-12">
          ...
          <p className="text-sm leading-[1.6] max-w-lg" style={{ color: "var(--dark-text-body)" }}>
          ...
          {experiences.slice(0, 2).map((exp) => (
            ...
            style={{ color: "var(--dark-text-heading)" }}
                ...
                >
                  ...
                  {/* Description — body color, must be clearly readable */}
                  <p
